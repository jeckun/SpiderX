...
class Site():
    ...
    def get_article(self, story):
        ...
        self.get(story.url)
        # 解析文章信息
        story.author= self.page.ele(CONFIG['author']).ele('tag:a').text,
        ...
        story.content= self.get_article_content(CONFIG['story_content'])
        story.series= self.check_series(story, self.page.eles(CONFIG['series']))
